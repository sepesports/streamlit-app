  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    table {
      ...
      font-size: 13px;
      min-width: 700px;
      table-layout: fixed; /* Control más preciso sobre anchos */
    }
    thead th {
      text-align: left;
      padding: 8px 6px;
    ...
    @media (max-width: 768px) {
      ...
      /* Ajustes de ancho para móvil usando table-layout fixed */
      table { min-width: 0; width: 100%; font-size: 12px; }
      /* Definir anchos de columnas visibles */
      th:nth-child(3), td:nth-child(3) { width: 15%; } /* Día */
      th:nth-child(4), td:nth-child(4) { width: 20%; } /* Inicio */
      th:nth-child(5), td:nth-child(5) { width: 20%; } /* Finaliza */
  ...
  <script>
    ...
    function render() {
      ...
      slice.forEach((r, idx) => {
        ...
        // Crear array de celdas en el orden exacto del thead
        const cells = [];

        // Columna 0: Instalacion
        const tdInst = document.createElement("td");
        tdInst.className = "col-instalacion";
        tdInst.textContent = instalacion;
        cells.push(tdInst);

        // Columna 1: Socorrista
