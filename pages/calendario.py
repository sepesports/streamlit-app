...
# Versión corregida: inyección de datos segura con json.dumps
# ==============================================================================
...
# Convertir a JSON para obtener strings válidos en JavaScript
user_json = json.dumps(AUTH_USER)
role_json = json.dumps(AUTH_ROLE)
dni_json = json.dumps(AUTH_DNI)

# El HTML es un string normal (no raw) para poder usar .replace después,
# pero mantenemos las dobles llaves para las partes que no deben ser reemplazadas.
html_template = """
<!doctype html>
<html>
<head>
      ...
      <div id="wrap">
        ...
        <div id="agenda" class="panel agendaBlock">
          ...
          <div class="meta agendaMeta" id="agendaMeta">
            ...
            <div><b>Usuario:</b> <span id="userDisplay">__AUTH_USER__</span> (<span id="roleDisplay">__AUTH_ROLE__</span>)</div>
          </div>
...
(function(){
  ...
  // Usuario autenticado (valores inyectados directamente como JSON)
...
# Reemplazar placeholders de usuario con valores JSON seguros
...
# Reemplazar placeholders de configuración visual
